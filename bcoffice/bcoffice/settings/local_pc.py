...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://172.16.15.251:6379",
...
# API_HOST = '172.16.15.252' # 거래소 API 호스트 주소
API_HOST = '127.0.0.1:3000' # 거래소 API 호스트 주소
...
COIN_MANAGER_ADDRESS = 'http://13.209.211.149:3001'
...
STATS_API_KEY = 'kBzo2P6qEDymHbACR9Q1L1ZKaDuYIYos'