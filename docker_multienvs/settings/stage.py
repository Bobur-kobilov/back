...
DATABASES = {
    ...
    'exchange': {
        ...
        'USER': 'devsynco',
        'PASSWORD': '21Cpdlsb96',
        'HOST': 'dev-chainb-exchainge.c96sjzsh7dzo.ap-northeast-2.rds.amazonaws.com',
        'PORT': '3306',
        'OPTIONS': {
            'init_command': "SET " +
                "sql_mode='STRICT_TRANS_TABLES'," +
...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://dev-chainb.tfp4ss.0001.apn2.cache.amazonaws.com:6379",
...
API_HOST = 'internal-dev-chainb-bo-api-887851610.ap-northeast-2.elb.amazonaws.com' # 거래소 API 호스트 주소
...
STATS_API_KEY = 'Xz6TeIAPyz0lTz0Cq3AhdPaQw92DP8iA'